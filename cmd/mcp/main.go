...
// read scope; MCP_READWRITE_KEY grants read-write (kept for the future
// write seam even though no write tool is registered yet). If neither is
// set the server still starts but rejects every request (fail closed) --
