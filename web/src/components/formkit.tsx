 ...
 * every remote's copy is allowed to diverge slightly). Styled purely off
...
export function SubmitButton({
   ...
   *  outside a <form> submit flow (e.g. the Cancel order action). */
  onClick?: () => void;
  type?: "submit" | "button";
  /** "danger" for destructive actions (Cancel order) so they read as
   *  visually distinct from the primary Place order action. */
  tone?: "accent" | "danger";
}) {
  const bg = disabled
    ? "var(--wh-color-border)"
